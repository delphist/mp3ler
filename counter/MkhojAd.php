...
<?php
    ...
    $mkhoj_siteid = 'b05e6609df2544a89ac334b067d7944d';
    ...
    $mkhoj_url     = $mkhoj_test 
             ? 'http://w.sandbox.inmobi.com/showad.asm'
             : 'http://eu.w.inmobi.com/showad.asm';
    $mkhoj_timeout = 12;
    ...
    if( null !== $mkhoj_response ) {
		$mkhoj_response = str_replace('<a ', '<a no-ajax="no-ajax"', $mkhoj_response);
	}
    echo( $mkhoj_response );
