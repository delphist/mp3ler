...
<ul class="list" data-role="listview" itemscope itemtype="http://schema.org/MusicGroup">
    ...
    <?php foreach($queries as $query) { ?>
        <li data-icon="false"><a href="<?=$this->createUrl('query/view', array('text' => $query->text))?>" title="<?=CHtml::encode($query->text)?> mp3"><?=$query->title?> <span>(<?=number_format((int) $query->results_count, 0, '.', ' ')?>)</span></a></li>
    <?php } ?>
</ul>